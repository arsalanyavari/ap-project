...
if you want try to running program please install app by using &lt;&gt; otherwise please doing these steps:
...
6\)move "files" directory into &lt;&gt; directories thet existing in build... directory 
